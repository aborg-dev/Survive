...
public class UITest extends GdxTest {
	...
	public void create() {
		...
		skin = new Skin(Gdx.files.internal("Main/data/uiskin.json"));
		texture1 = new Texture(Gdx.files.internal("Main/data/badlogicsmall.jpg"));
		texture2 = new Texture(Gdx.files.internal("Main/data/badlogic.jpg"));
